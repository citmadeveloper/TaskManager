...
const CreateTask = () => {
  ...
  const createTask = async () => {
    ...
    try {
      ...
      const sanitizedAttachments = taskData.attachments?.filter(
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            ...
            <div className="mt-4">
              ...
              <input className='form-input' placeholder='Create App UI' value={taskData.title} onChange={({ target }) => handleValueChange("title", target.value)} />
            </div>
