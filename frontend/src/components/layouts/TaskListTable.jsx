            ...
            <table className="min-w-full">
                <thead className="bg-white">
                    <tr className="text-left">
                        <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">Name</th>
                        <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">Status</th>
                        <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">Priority</th>
                        <th className="py-3 px-4 text-gray-800 font-medium text-[13px] whitespace-nowrap">Created On</th>
                    </tr>
                </thead>
                <tbody>
                    {tableData.map((task) => (
                        <tr key={task._id} className="border-t border-gray-200">
                            <td className="py-4 px-4 text-gray-700 text-[13px] max-w-[150px] truncate">
                                {task.title}
                            </td>
