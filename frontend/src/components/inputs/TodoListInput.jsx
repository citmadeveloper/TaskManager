    ...
    return (
        <div className=''>
            ...
            <div className="flex items-center gap-5 mt-4">
                <input type="text" placeholder='Enter Task' value={option} onChange={({ target }) => setOption(target.value)} className='w-full text-[13px] text-black outline-none bg-white border  border-gray-300 px-3 py-2 rounded-md hover:border-blue-300' />
